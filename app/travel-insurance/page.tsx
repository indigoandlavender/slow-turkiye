...
export const metadata: Metadata = {
  title: "Travel Insurance | Slow Türkiye",
  description: "Travel insurance requirements and recommendations for Türkiye journeys.",
};
        ...
        <div className="bg-white/10 text-white p-6 mb-12 flex gap-4">
          ...
          <div>
            ...
            <p className="text-white/60 text-sm">
              Comprehensive travel insurance is a condition of booking with Slow Türkiye. 
        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              ...
              14 days before departure. Email it to hello@slowturkiye.com with your 
              booking reference.
            </p>
          </section>
          ...
          <section className="border-t border-white/10 pt-12">
            <p className="text-white/50 text-center">
              ...
              <Link href="/contact" className="underline hover:text-white/90">
                Contact us
              </Link>
            </p>
          </section>
