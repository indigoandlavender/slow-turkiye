    ...
    const finalColumns = columns.length > 0 ? columns : [
      {
        ...
        links: [
          ...
          { order: 4, label: "Pinterest", href: "https://pinterest.com/slowmorocco", type: "social" },
          { order: 5, label: "Instagram", href: "https://instagram.com/slowmorocco", type: "social" },
          { order: 6, label: "YouTube", href: "https://youtube.com/@slowmorocco", type: "social" },
        ],
      },
      {
        number: 2,
